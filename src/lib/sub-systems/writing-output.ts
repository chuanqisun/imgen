...
import { BehaviorSubject, fromEvent, Observable, switchMap, tap } from "rxjs";
import type { LlmNode } from "../ai-bar/lib/elements/llm-node";
import { system, user } from "../ai-bar/lib/message";
import { $ } from "../dom";

export function useWritingOutput(props: { currentWorldXML: BehaviorSubject<string> }) {
